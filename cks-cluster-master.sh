...
KUBELET_EXTRA_ARGS="--container-runtime remote --container-runtime-endpoint unix:///run/containerd/containerd.sock --apiserver-advertise-address 192.168.56.10"
EOF
}
...
kubeadm init --kubernetes-version=${KUBE_VERSION} --ignore-preflight-errors=NumCPU --skip-token-print --apiserver-advertise-address 192.168.56.10 --pod-network-cidr 172.16.0.0/16
